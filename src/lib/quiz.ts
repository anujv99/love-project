const questions = [
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        response:
          "Really moni ji 😒? That's far from the first promise I made you, while we quickly fell in love and told each other that we were in love, I'm afraid that this is not the first promise I made to you. I love you moni ji, and nothing in this world can change how I feel about you, you're my world and I will love you forever.",
      },
    ],
  ...
  },
  {
    ...
    options: [
      {
        text: "Eastside",
        response: `That's right 🥹! Eastside was the first song I sent you and I sent it on JS, I sent this because you said you liked low volume songs (not the right word but I guess you know what I mean), and this song instantly clicked in my mind, and if I remember correctly you did like this song. I really like this line from this song "we can do anything if we put our mind to it", I really belive in these words just like I belive in us 😀.`,
      },
      {
        text: "Samjho na",
        response:
          "Really 😑???? I never sent you any hindi song until very late, in fact, this was the first that you sent me, you also sent another one but I don't remember the name, that one was urdu or punjabi, but Samjho na was the first and I really liked it.",
      },
      {
        text: "Sunflower",
